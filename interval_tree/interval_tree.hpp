...
//############################################################################################################
    ...
    public:
        ...
        {
          //fint
            return find_next(from, ival, [](lib_interval_tree::interval<float, lib_interval_tree::closed> const& lhs, lib_interval_tree::interval<float, lib_interval_tree::closed> const& rhs){return lhs == rhs;});
        }
        ...
        {
          //fint
            return find(ival, [](lib_interval_tree::interval<float, lib_interval_tree::closed> const& lhs, lib_interval_tree::interval<float, lib_interval_tree::closed> const& rhs){return lhs == rhs;});
        }
